...
public class Auth {
  ...
  public Auth(String error, String error_description, String access_token, String token_type, int expires_in, String refresh_token, String error_uri, String scope) {
    this.error = error;
